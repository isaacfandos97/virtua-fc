...
export default function liveMatch(config) {
    ...
    const component = {
        ...
        async autoSubUserTeamBeforeSkip(minute) {
            ...
            // Regenerate match summary with updated scores, events, and MVP.
            // The summary was already generated by enterFullTime() before this
            // async response arrived, so it may have stale data.
